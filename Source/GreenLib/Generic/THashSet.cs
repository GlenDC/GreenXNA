...
{
    public sealed class THashSet<TValue> : ITemplateType
        where TValue:ITemplateType
    {
        HashSet<TValue> m_Value;
        ...
        public THashSet(HashSet<TValue> value)
        {
            Set(value);
        }
        ...
        public object Clone()
        {
            HashSet<TValue> setClone = new HashSet<TValue>();
            var enumerator = m_Value.GetEnumerator();
            while (enumerator.MoveNext())
            {
                var current = enumerator.Current;
            ...
            THashSet<TValue> clone = new THashSet<TValue>(setClone);
            return clone;
        }

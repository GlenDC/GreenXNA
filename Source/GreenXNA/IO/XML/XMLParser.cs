...
namespace GreenXNA.IO.XML
{
    ...
    /// </summary>
    public struct XMLRootInformation : IDisposable
    {
        /// <summary>
    ...
    /// </summary>
    public struct XMLFile : IDisposable
    {
        /// <summary>
        ...
        public void Dispose()
        {
            ...
            foreach (KeyValuePair<string, List<ParserLayer>> layerList in LayerList)
            {
                foreach (ParserLayer layer in layerList.Value)
                {
                    layer.Dispose();
                }
            }
    ...
    /// </summary>
    public struct ParserLayer : IDisposable
    {
        /// <summary>
        ...
        public void Dispose()
        {
            ...
            foreach (KeyValuePair<string, List<ParserLayer>> children in Children)
            {
